...
def create_news(
    ...
    return read_news(news=new_news, user=user, session=session)
...
def get_all_news(
    ...
    return [
        read_news(news=news, user=user, session=session) for news in all_news
    ]
...
def get_news(
    ...
    if news := crud.get_news(idx, session):
        return read_news(news=news, user=user, session=session)
...
def update_news(
    ...
    return read_news(news=updated_news, user=user, session=session)
